...
export default function VintageLetterPage() {
  ...
  async function downloadLetter() {
    ...
    try {
      ...
      link.download = `classified-letter-${Date.now()}.png`;
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              "THAT WHICH CONSUMES ITSELF SHALL BE REBORN"
            </div>
            <div
              style={{
                width: "250px",
          ...
          <div className="flex justify-between mb-8" style={{ fontSize: "12px" }}>
            <div style={{ color: "#5a4a2a" }}>
              REF: OBF-{String(today.getMonth() + 1).padStart(2, "0")}{String(today.getDate()).padStart(2, "0")}-{Math.floor(Math.random() * 9000) + 1000}
            </div>
